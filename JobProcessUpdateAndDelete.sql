...
EXEC dbo.sp_add_job
    @job_name = N'ProcessDeletionQueue_pizza_demo_DB2',
    @enabled = 1,
    @description = N'Process scheduled deletions daily at 00:00 - pizza_demo_DB2 only';

EXEC dbo.sp_add_job
    @job_name = N'ProcessDiscountUpdateQueue_pizza_demo_DB2',
    @enabled = 1,
    @description = N'Process scheduled discount updates daily at 00:00 - pizza_demo_DB2 only';
...
EXEC sp_add_jobstep
    ...
    @database_name = N'pizza_demo_DB2';
