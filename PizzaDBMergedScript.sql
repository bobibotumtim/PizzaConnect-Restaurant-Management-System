...
CREATE TABLE [Order] (
    ...
    TableID INT NULL FOREIGN KEY REFERENCES [Table](TableID), -- Đã thêm FK từ kịch bản của bạn bạn
...
CREATE TABLE OrderDetail (
    ...
    ProductSizeID INT FOREIGN KEY REFERENCES ProductSize(ProductSizeID), -- Dùng ProductSizeID từ kịch bản của bạn
    Quantity INT NOT NULL,
    TotalPrice DECIMAL(10,2),
    SpecialInstructions NVARCHAR(255),
    EmployeeID INT NULL, -- Nhân viên phụ trách (VD: Chef)
...
(1, 2, 3, 1, 'Paid', 120000, N'Regular customer'), -- Sửa giá cho hợp lý
...
-- Discounts 
INSERT INTO Discount (Description, DiscountType, Value, MaxDiscount, MinOrderTotal, StartDate, EndDate, CustomerOnly, IsActive)
VALUES
(N'10% off drinks', 'Percentage', 10, NULL, 0, '2025-10-01', '2025-10-31', 0, 1),
(N'Fixed 20K off over 200K', 'Fixed', 20000, NULL, 200000, '2025-10-15', '2025-11-15', 1, 1),
(N'Loyalty points', 'Loyalty', 100, NULL, 0, '2025-10-01', NULL, 1, 1),
('Weekend Special 15%', 'Percentage', 15, 50000, 150000, '2025-10-01', '2025-12-31', 0, 1),
('Birthday Discount 20%', 'Percentage', 20, 100000, 200000, '2025-01-01', '2025-12-31', 1, 1),
('Free Drink Combo', 'Fixed', 30000, 30000, 250000, '2025-10-15', '2025-11-15', 0, 1),
('Student Discount 10%', 'Percentage', 10, 25000, 100000, '2025-09-01', '2025-12-31', 1, 1),
('Family Meal 25%', 'Percentage', 25, 75000, 350000, '2025-10-01', '2025-10-31', 0, 1);
GO
...
BEGIN
    ...
    ELSE
    BEGIN
        INSERT INTO DiscountUpdateQueue (DiscountID, Description, DiscountType, Value, MaxDiscount, MinOrderTotal, StartDate, EndDate, CustomerOnly, ScheduledUpdate)
        VALUES (@DiscountID, @Description, @DiscountType, @Value, @MaxDiscount, @MinOrderTotal, @StartDate, @EndDate, @CustomerOnly, @ScheduledTime);
    END
END
GO
