...
public class DBContext {
    ...
    private static final String URL = "jdbc:sqlserver://localhost:1433;databaseName=pizza_demo_DB_FinalModel_Combined2;encrypt=true;trustServerCertificate=true";
