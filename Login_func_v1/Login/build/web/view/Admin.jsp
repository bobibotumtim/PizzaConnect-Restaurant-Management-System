    ...
    <head>
        ...
        <style>
            * {
            ...
            /* Pagination styles (matching top buttons) */
                ...
                <div class="table-container">
                    ...
                    <div class="pagination-container">
                        ...
                        <form method="get" action="admin">
                            ...
                            <button type="submit" class="btn btn-info" <%= (currentPage == 1 ? "disabled" : "") %>>Previous</button>
                        </form>

                        <!-- Page buttons -->
                        <% for (int i = 1; i <= totalPages; i++) { 
                                String btnClass = (i == currentPage) ? "btn-success page-current" : "btn-warning";
                        %>
                        <form method="get" action="admin">
                            <input type="hidden" name="page" value="<%= i %>">
                            <button type="submit" class="btn <%= btnClass %>"><%= i %></button>
                        </form>
                        <% } %>
                        ...
                        <form method="get" action="admin">
                            ...
                            <button type="submit" class="btn btn-info" <%= (currentPage == totalPages ? "disabled" : "") %>>Next</button>
                        </form>
                        <% } %>
                    </div>
