...
<%-- ✅ Đã sửa: Dùng contextPath an toàn (dù ${} đang lỗi) --%>
<c:url var="formAction" value="/EditProductSizeServlet" />

<h2>Edit Size: ${size.sizeCode}</h2>

<form action="${formAction}" method="post" id="editSizeForm">
    
...
            </c:forEach>
        </select>
        <%-- ✅ KHÔI PHỤC LẠI PLACEHOLDER & CLASS --%>
        <input type="number" id="editNewQuantity_EditSize" placeholder="Quantity" class="border p-2 w-24 rounded">
        <input type="text" id="editNewUnit_EditSize" placeholder="Unit" class="border p-2 w-24 rounded" readonly>
        <%-- ✅ KHÔI PHỤC LẠI CLASS --%>
        <button type="button" id="editAddIngredientBtn_EditSize" class="bg-green-500 text-white px-3 py-2 rounded">Add</button>
    </div>
