        ...
        <script>
            ...
            function orderItemRowTemplate() {
                ...
                <div class="order-item-row grid grid-cols-5 gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                        <label for="price-input" class="block text-xs font-semibold text-gray-700 mb-1">Price</label>
                        <input id="price-input" name="price" type="number" step="0.01" value="25.00" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" required />
                    </div>
