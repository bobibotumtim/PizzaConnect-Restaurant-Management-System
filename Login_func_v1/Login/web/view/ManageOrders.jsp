                                                    ...
                                                    <div class="flex flex-wrap gap-4 items-center justify-between">
                                                        <div class="flex flex-wrap gap-4 items-center flex-1">
                                                            <div class="flex-1 min-w-[250px]">
                                                                <label
                                                                    class="block text-sm font-semibold text-gray-700 mb-2">Filter
                                                                    by Status</label>
                            ...
                            <div id="addOrderModal" class="modal">
                                <div
                                    ...
                                    <form id="addOrderForm" onsubmit="submitAddOrderForm(event)" class="p-6">
                                        <div class="space-y-4">
                                            <div>
                                                <label class="block text-sm font-semibold text-gray-700 mb-2">Order
                                                    Items</label>
                                ...
                                <div class="bg-white rounded-xl shadow-2xl max-w-md w-full m-4 fade-in">
                                    ...
                                    <form id="editOrderForm" onsubmit="submitEditOrderForm(event)" class="p-6">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                <label class="block text-sm font-semibold text-gray-700 mb-2">Payment
                                                    Status</label>
