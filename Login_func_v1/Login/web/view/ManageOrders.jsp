...
<body class="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="text-right">
                        ...
                        <div class="text-sm text-red-100"><%= user != null && user.getRole() == 1 ? "Admin" : "Employee" %></div>
                    </div>
                    <a href="Login?action=logout" class="bg-white text-red-500 px-4 py-2 rounded-lg font-semibold hover:bg-red-50 transition-all">
                        Logout
                    </a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-8">
            <div class="flex flex-wrap gap-4 items-center justify-between">
                ...
                <div class="flex gap-2">
                    <button onclick="openAddOrderModal()" class="bg-green-500 text-white px-6 py-2 rounded-lg font-semibold flex items-center gap-2 hover:bg-green-600 transition-all shadow-md">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        New Order
                    </button>
                    <a href="${pageContext.request.contextPath}/manage-orders" class="bg-blue-500 text-white px-6 py-2 rounded-lg font-semibold flex items-center gap-2 hover:bg-blue-600 transition-all">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="font-bold text-gray-900">$<%= String.format("%.2f", order.getTotalPrice()) %></span>
                            </td>
                            <td class="px-6 py-4">
                                <% 
                                    String statusClass = "";
    ...
    <div id="addOrderModal" class="modal">
        <div class="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-auto m-4 fade-in">
            <div class="bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-4 flex items-center justify-between rounded-t-xl">
                ...
                <button onclick="closeAddOrderModal()" class="hover:bg-green-700 rounded-full p-1">
            ...
            <form id="addOrderForm" onsubmit="submitAddOrderForm(event)" class="p-6">
                <div class="space-y-4">
                    <div>
                        ...
                        <button type="button" onclick="addOrderItemRow()" class="mt-3 w-full bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                            </svg>
                            Add Pizza
                ...
                <div id="addOrderError" class="hidden mt-4 p-3 bg-red-100 text-red-700 rounded-lg"></div>
                
                <div class="flex justify-end gap-3 mt-6">
                    <button type="button" onclick="closeAddOrderModal()" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                        Cancel
                    </button>
    ...
    <div id="editOrderModal" class="modal">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full m-4 fade-in">
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-4 flex items-center justify-between rounded-t-xl">
                ...
                <button onclick="closeEditOrderModal()" class="hover:bg-blue-700 rounded-full p-1">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                    </svg>
                </button>
            ...
            <form id="editOrderForm" onsubmit="submitEditOrderForm(event)" class="p-6">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Status</label>
                        <select id="editStatus" name="status" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="0">Pending</option>
                            <option value="1">Processing</option>
                            <option value="2">Completed</option>
                            <option value="3">Cancelled</option>
                    ...
                    <div>
                        ...
                        <select id="editPaymentStatus" name="paymentStatus" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div id="editOrderError" class="hidden mt-4 p-3 bg-red-100 text-red-700 rounded-lg"></div>
                
                <div class="flex justify-end gap-3 mt-6">
                    <button type="button" onclick="closeEditOrderModal()" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                        Cancel
                    </button>
