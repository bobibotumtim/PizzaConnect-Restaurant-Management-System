        ...
        <%@ page import="java.text.SimpleDateFormat" %>
            ...
            <body class="flex h-screen bg-gray-50">
                ...
                <% String currentPath=request.getRequestURI(); User currentUser=(User)
                    request.getAttribute("currentUser"); User editUser=(User) request.getAttribute("editUser"); String
                    message=(String) request.getAttribute("message"); String error=(String)
                    request.getAttribute("error"); SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd"); String
                    dobString="" ; if (editUser !=null && editUser.getDateOfBirth() !=null) {
                    ...
                    <div class="flex-1 flex flex-col overflow-hidden">
                        ...
                        <div class="flex-1 p-6 overflow-auto">
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl mb-6 flex items-center space-x-2">
                                ...
                                <a href="dashboard"
                                    class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg">Dashboard</a>
                            </div>
                                            ...
                                            <% if (editUser !=null) { %>
                                                ...
                                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-blue-700">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span
                                                                class="px-2 py-1 rounded-full text-xs <%= editUser.isActive() ? "
                                                        ...
                                                        <div>
                                                            ...
                                                            <% if (editUser.getRole()==1) { %>
                                                                <span
                                                                    class="px-2 py-1 rounded-full text-xs bg-red-100 text-red-800">Admin</span>
                                                                <% } else if (editUser.getRole()==2) { %>
                                                                    <span
                                                                        class="px-2 py-1 rounded-full text-xs bg-orange-100 text-orange-800">Employee</span>
                                                                    <% } else { %>
                                                                        <span
                                                                            class="px-2 py-1 rounded-full text-xs bg-green-100 text-green-800">Customer</span>
                                                                        <% } %>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                                                    ...
                                                    <form method="post" action="edituser" class="p-6">
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            ...
                                                            <div>
                                                                ...
                                                                <select id="role" name="role" required
                                                                    ...
                                                                    class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500">
                                                                    <option value="1" <%=editUser.getRole()==1
                                                                        ? "selected" : "" %>>Admin</option>
                                                                    <option value="2" <%=editUser.getRole()==2
                                                                        ? "selected" : "" %>>Employee</option>
                                                                    <option value="3" <%=editUser.getRole()==3
                                                                        ? "selected" : "" %>>Customer</option>
                                                                </select>
                                                            </div>
                                                            <% String currentEmployeeRole="" ; if
                                                                (editUser.getRole()==2) { // Get employee role from
                                                                database dao.EmployeeDAO empDAO=new dao.EmployeeDAO();
                                                                models.Employee
                                                                emp=empDAO.getEmployeeByUserId(editUser.getUserID()); if
                                                                (emp !=null) { currentEmployeeRole=emp.getJobRole(); } }
                                                                %>
                                                                <div id="employeeRoleDiv"
                                                                    style="display: <%= editUser.getRole() == 2 ? "
                                                                    block" : "none" %>;">
                                                                    <label for="employeeRole"
                                                                        class="block text-sm font-medium text-gray-700 mb-2">Employee
                                                                        Role *</label>
                                                                    <select id="employeeRole" name="employeeRole"
                                                                        class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500">
                                                                        <option value="">Select Employee Role</option>
                                                                        <option value="Manager" <%="Manager"
                                                                            .equals(currentEmployeeRole) ? "selected"
                                                                            : "" %>>Manager</option>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="date" id="dateOfBirth"
                                                                        name="dateOfBirth" value="<%= dobString %>"
                                                                        class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500">
                                                                </div>
                                                                <div>
                                                                    <label for="gender"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select id="isActive" name="isActive"
                                                                        class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500">
                                                                        <option value="true" <%=editUser.isActive()
                                                                            ? "selected" : "" %>>Active</option>
                                                                        <option value="false" <%=!editUser.isActive()
                                                        ...
                                                        <div class="flex justify-center space-x-4 mt-8">
                                                            ...
                                                            <a href="admin"
                                                                class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-lg flex items-center">
                                                ...
                                                <% } else { %>
                                                    <div class="text-center py-12">
                                                        ...
                                                        <h3 class="text-lg font-medium text-gray-900 mb-2">User Not
                                                            Found</h3>
                                                        <p class="text-gray-500 mb-4">The user you're trying to edit
                                                            could not be found.</p>
                                                        <a href="admin"
                                                            class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg">Back
                                                            to Users</a>
                                                    </div>
                                                    <% } %>
                        </div>
