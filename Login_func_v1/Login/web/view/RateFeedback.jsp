...
<html lang="vi">
  ...
  <body>
    <div class="container">
      <% Boolean validOrderId = (Boolean) request.getAttribute("validOrderId");
      Integer orderId = (Integer) request.getAttribute("orderId"); if
      (validOrderId == null || !validOrderId || orderId == null || orderId == 0)
      { %>
      <h1>⚠️ Lỗi</h1>
